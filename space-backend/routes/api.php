...
Route::middleware(['auth:sanctum', 'role:super-admin,admin,ti,lider,comercial,designer'])->group(function () {
    ...
    Route::get('/producao/get-pedidos-arte-final', [PedidoArteFinalController::class, 'getAllPedidos']);
    Route::get('/producao/pedido-arte-final', [PedidoArteFinalController::class, 'getAllPedidos']);
    Route::put('/producao/pedido-arte-final', [PedidoArteFinalController::class, 'upsertPedido']);
