...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pedidos', function (Blueprint $table) {
            ...
            $table->dateTime('data_esperada')->nullable();
            ...
            $table->foreignId('designer_id')->constrained()->onDelete('SET NULL');
            $table->foreignId('pedido_status_id')->constrained()->onDelete('SET NULL');
            $table->foreignId('pedido_tipo_id')->constrained()->onDelete('SET NULL');
